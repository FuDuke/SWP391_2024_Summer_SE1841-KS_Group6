...
<html lang="en">
    <head>
        ...
        <script>
            function doDelete(restaurant_name) {
                var c = confirm("Are you sure?");
                if (c) {
                    window.location.href = "Delete_One_Restaurant?dname=" + encodeURIComponent(restaurant_name);
                }
            }
        </script>
        <!--[if lt IE 8]>
            ...
            <div class="container_12">
                <div class="banners">
                    <div class="containerr">
                        <div class="contentt">
                            <img src="images/${res.image}" alt="Trishuli River Rafting">
                            <div class="detailss">
                                <h2>${res.restaurant_name} ${roleMap[res.service_category_id]}</h2>

                                <div class="pricee">
                                Time Open:    ${res.time_open}
                                </div>
                                <div class="pricee">
                                Time Close:    ${res.time_close}
                                </div>
                                ...
                                <div class="buttons">
                                    <button class="update">
                                        <a href="Update_One_Restaurant?rname=${res.restaurant_name}">Update</a>
                                    </button>
                                    <button class="delete">
                                        <a href="#" onclick="doDelete('${res.restaurant_name}')">DELETE</a>
                                    </button>
                                </div>
                            </div>
                        </div>
