...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="content">
                <form name="restaurantForm" action="Add_One_Restaurant" method="get" onsubmit="return validateForm()">
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td>Time Open:</td>
                            <td><input type="text" name="time_open" placeholder="hh:mm" required></td>
                        </tr>
                        <tr>
                            <td>Time Close:</td>
                            <td><input type="text" name="time_close" placeholder="hh:mm" required></td>
                        </tr>
                        <tr>
                            <td>Description:</td>
                        ...
                        <tr>
                            <td colspan="2" class="buttons"><input type="submit" value="Add Restaurant"></td>
                        </tr>
                    </table>
                </form>
            </div>
