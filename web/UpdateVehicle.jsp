...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="content">
                <form name="hotelForm" action="Update_Vehicle" method="post" onsubmit="return validateForm()">
                    <table>
                        <tr>
                            <td>Vehicle ID:</td>
                            <td><input type="text" value="${update.vehicle_id}" name="vehicle_id" required></td>
                        </tr>
                        <tr>
                            <td>Vehicle name:</td>
                            <td><input type="text" value="${update.vehicle_name}" name="vehicle_name" required></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Vehicle type</td>
                            <td><input type="text" value="${update.vehicle_type}" name="vehicle_type" required></td>
                        </tr>
                        <tr>
                            <td>Number seat</td>
                            <td><input type="text" value="${update.number_seat}" name="number_seat" required></td>
                        </tr>
                        <tr>
                            <td>Phone:</td>
