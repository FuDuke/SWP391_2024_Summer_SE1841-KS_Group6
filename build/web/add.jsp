...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="content">
                <form action="Add_One_Tour" method="get">
                    <table>
                        <tr>
                            <td>Tour Name:</td>
                        ...
                        <tr>
                            <td>Min Child:</td>
                            <td><input type="text" oninput="validateNumberInput(event)"
                                       name="min_child" required></td>
                        </tr>
                        <tr>
                            <td>Max Child:</td>
                            <td><input type="text" oninput="validateNumberInput(event)"
                                       name="max_child" required></td>
                        </tr>
                        <tr>
                            <td>Min Adult:</td>
                            <td><input type="text" oninput="validateNumberInput(event)"
                                       name="min_adult" required></td>
                        </tr>
                        <tr>
                            <td>Max Adult:</td>
                            <td><input type="text" oninput="validateNumberInput(event)"
                                       name="max_adult" required></td>
                        </tr>
                        <tr>
                            <td>Total Price:</td>
                            <td><input type="text" oninput="validateNumberInput(event)"
                                       name="total_price" required></td>
                        </tr>
                        <tr>
                            <td>Number of Days:</td>
                            <td><input type="text" oninput="validateNumberInput(event)"
                                       name="number_day" required></td>
                        </tr>
                        <tr>
                            <td>Tour Category:</td>
                            <td>
