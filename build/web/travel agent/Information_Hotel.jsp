            ...
            <div class="container_12">
                <div class="banners">
                    <div class="containerr">
                        <div class="contentt">
                            <img src="images/${ho.image}" alt="Trishuli River Rafting">
                            <div class="detailss">
                                <h2>${ho.hotel_name} ${roleMap[ho.service_category_id]}</h2>

                                <div class="pricee">
                                    Price:    ${ho.daily_price}
                                </div>
                                <div class="pricee">
                                    Sale when Holiday:    ${ho.holiday_price}
                                </div>
                                <div class="pricee">
                                    Number Room:    ${ho.number_room}
                                </div>

                                <div class="number" style="font-family: cursive; color: chocolate">
                                    People one Room: ${ho.number_people}
                                </div>
                                ...
                                <div class="buttons">
                                    <button class="update">
                                        <a href="Update_One_Hotel?hname=${ho.hotel_name}">Update</a>
                                    </button>
                                    <button class="delete">
                                        <a href="#" onclick="doDelete('${ho.hotel_name}')">DELETE</a>
                                    </button>
                                </div>
                            </div>
                        </div>
