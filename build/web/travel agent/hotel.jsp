...
<div class="content">
    ...
    <div class="container_12">
        <div class="banners">
            <div class="grid_12">
                <a href="add_hotel.jsp" class="btn-add-tour">Add Hotel</a>
            </div>

            <c:forEach var="a" items="${list_hotel}">
                <div class="grid_4">
                    <div class="banner">
                        <div class="crop">
                            <img src="images/${a.image}" alt="">
                            <div class="label">
                                <div class="title">${a.hotel_name}</div>
                                <div class="price">Price: ${a.daily_price}</div>
                                <div class="price">People one room: ${a.number_people}</div>
                                <a href="Information_Hotel_TravelAgent?hname=${a.hotel_name}" class="btn-book-now">View</a>
                            </div>
                        </div>
                    </div>
                </div>
