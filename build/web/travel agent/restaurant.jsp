...
<div class="content">
    ...
    <div class="container_12">
        <div class="banners">
            <div class="grid_12">
                <a href="add_restaurant.jsp" class="btn-add-tour">Add Restaurant</a>
            </div>
                    ...
                    <div class="banner">
                        <div class="crop">
                            ...
                            <div class="label">
                                ...
                                <div class="price">Open: ${a.time_open}</div>
                                <div class="price">Close: ${a.time_close}</div>
                                <a href="Information_Restaurant_TravelAgent?rname=${a.restaurant_name}" class="btn-book-now">View</a>
                            </div>
                        </div>
                    </div>
                </div>
